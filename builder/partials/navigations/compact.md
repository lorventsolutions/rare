...
It contains Compact menu part which we can include in Compact menu layout.
            ...
            <ul class="navigation">
                <li class="menu-dropdown {% if (page == 'index1') or (page == 'index2') or (page == 'index3')  %} active{% endif %}">
                    <a href="#" class="dropdown_head">
                        ...
                        <i class="menu_icon_dropdown ti-angle-right"></i>
                        <p class="mm-text ">Dashboard</p>
                    </a>
                    <ul class="sub_menu">
                ...
                <li class="menu-dropdown {% if (page == 'cards') or (page == 'advancedCards') or (page == 'draggableCards')  %} active{% endif %}">
                    <a href="#" class="dropdown_head">
                        <i class="ti-layers-alt menu_icon text-info"></i>
                        <i class="menu_icon_dropdown ti-angle-right"></i>
                        <p>Cards</p>
                    </a>
                    <ul class="sub_menu">
                ...
                <li {% if page =='blank'%} class="active" id="active" {% endif %}>
                    <a href="blank.html">
                        <i class="menu_icon ti-file text-info"></i>
                        <p>Blank</p>
                    </a>
                </li>
                <li>
                    <a href="login.html">
                        <i class="menu_icon ti-shift-right text-success"></i>
                        <p>Login</p>
                    </a>
                </li>
                <li>
                    <a href="register.html">
                        <i class="menu_icon ti-marker-alt text-warning"></i>
                        <p>Register</p>
                    </a>
                </li>
                ...
                <li class="menu-dropdown menu_level">
                    <a href="#" class="dropdown_head">
